  ...
  return (
    ...
    >
      {products.map((product: EnrichedProducts, index: number) => {
        return (
          <div
            className={`flex justify-between border border-solid  w-10/12 border-border-primary rounded-md overflow-hidden ${
          ...
          >
            <Link
              ...
              }w-auto h-auto hover:scale-105 transition-all`}
            >
              <Images
                image={product.image}
                name={product.name}
